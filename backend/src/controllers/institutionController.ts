...
export const lookupInstitution = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    //DATABASE FETCH (With Promise tracking)
    const fetchPromise = (async () => {
      const data = await db.aisheDirectory.findUnique({
